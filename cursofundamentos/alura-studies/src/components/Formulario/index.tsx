...
function Formulario({ setTarefas } : Props){
    ...
    return(
        ...
        <div className={style.inputContainer}>
            ...
            value={tarefa} onChange={evento =>  setTarefa(evento.target.value)}
        ...
        <div className={style.inputContainer}>
            ...
            value={tempo} onChange={evento => setTempo(evento.target.value)}
        ...
        return(
            <form action="" className={style.novaTarefa} onSubmit={this.adicionarTarefa.bind(this)}>
                ...
                <div className={style.inputContainer}>
                    <label htmlFor="tempo">Tempo</label>
                    <input type="time" step="1"  name="tempo" 
                    value={this.state.tempo} onChange={evento => this.setState({...this.state, tempo: evento.target.value})}
                    id="tempo" min="00:00:00" max="01:30:00" required/>
